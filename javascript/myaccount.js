document.addEventListener("DOMContentLoaded", () => {
    ...
    // Tab Switcher Logic
    const tabButtons = document.querySelectorAll("#myAccountTabs .tab-btn");
    ...
    tabButtons.forEach(btn => {
        btn.addEventListener("click", (e) => {
            ...
            tabButtons.forEach(b => {
                b.classList.remove("active", "border-primary", "bg-white", "text-primary", "shadow-sm");
                b.classList.add("border-transparent", "text-muted", "hover:text-secondary", "hover:bg-gray-50");
            });

            btn.classList.remove("border-transparent", "text-muted", "hover:text-secondary", "hover:bg-gray-50");
            btn.classList.add("active", "border-primary", "bg-white", "text-primary", "shadow-sm");
